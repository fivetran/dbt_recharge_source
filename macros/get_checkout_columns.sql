...
{% set columns = [
    ...
    {"name": "discount_code", "datatype": dbt_utils.type_string()},
    {"name": "email", "datatype": dbt_utils.type_string()},
    {"name": "external_checkout_id", "datatype": dbt_utils.type_string()},
    {"name": "external_checkout_source", "datatype": dbt_utils.type_string()},
    {"name": "applied_discount_amount", "datatype": dbt_utils.type_string()},
    ...
    {"name": "applied_discount_value", "datatype": dbt_utils.type_string()},
    ...
    {"name": "shipping_rate_shipping_rate_checkout_subtotal_price", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_shipping_rate_checkout_total_price", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_shipping_rate_checkout_total_tax", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_code", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_delivery_range", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_description", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_handle", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_name", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_phone_required", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_price", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_title", "datatype": dbt_utils.type_string()},
    {"name": "requires_shipping", "datatype": "boolean"},
    {"name": "subtotal_price", "datatype": dbt_utils.type_string()},
    {"name": "taxes_included", "datatype": "boolean"},
    {"name": "total_price", "datatype": dbt_utils.type_string()},
    {"name": "total_tax", "datatype": dbt_utils.type_string()},
    {"name": "phone", "datatype": dbt_utils.type_string()},
    {"name": "updated_at", "datatype": dbt_utils.type_timestamp()},
    {"name": "note_attributes", "datatype": dbt_utils.type_string()},
