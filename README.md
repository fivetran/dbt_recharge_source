# [DEPRECATED] Recharge Source dbt package

> _This package has been archived and is no longer maintained. Use [`dbt_recharge`](https://github.com/fivetran/dbt_recharge) instead, which now contains all models previously found here._
...
- If you have questions or want to reach out for help, see the [GitHub Issue](https://github.com/fivetran/dbt_recharge_source/issues/new/choose) section to find the right avenue of support for you.
